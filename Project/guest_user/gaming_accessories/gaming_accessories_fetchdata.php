<?php
    ...
    /*
      // Fetch data from database for Gaming Accessories
    $sql = "SELECT Product_code, Product_name, Price, Category, Image FROM product_list WHERE Category = 'Gaming Accessories'";
